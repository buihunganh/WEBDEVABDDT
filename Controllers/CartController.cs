...
namespace BTL_WEBDEV2025.Controllers
{
    public class CartController : Controller
    {
        ...
        // Trang giỏ hàng: yêu cầu đăng nhập để hiển thị giỏ
        ...
        // Thêm sản phẩm vào giỏ (hợp nhất item cùng ProductId/Size/Color)
        [HttpPost]
        ...
        // Xóa 1 sản phẩm (theo ProductId/Size/Color)
        [HttpPost]
        ...
        // Lấy tổng số lượng item trong giỏ (để hiển thị badge)
        [HttpGet]
        ...
        // Thanh toán: tạo Order + OrderDetails, trả hướng dẫn thanh toán
        [HttpPost]
        ...
        // Trang xác nhận thanh toán (giản lược: tự gọi POST confirm bằng JS)
        [HttpGet]
        ...
        // Đánh dấu đơn đã thanh toán theo token (demo)
        [HttpPost]
        ...
        // Kiểm tra trạng thái thanh toán theo token
        [HttpGet]
