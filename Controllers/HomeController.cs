...
namespace BTL_WEBDEV2025.Controllers
{
    public class HomeController : Controller
    {
        ...
        // Trang chủ: lấy Featured/Deals và ảnh biểu tượng thương hiệu
        ...
        // Tìm ảnh trong wwwroot/media theo tên/thư mục thương hiệu (fallback)
        ...
        // Trang lỗi kèm RequestId để theo dõi
        public IActionResult Error()
        {
            return View(new ErrorViewModel { RequestId = Activity.Current?.Id ?? HttpContext.TraceIdentifier });
        }

        // Dữ liệu mẫu khi DB trống/không kết nối được
        ...
        // Cố gắng lấy dữ liệu từ DB, nếu không thì dùng dữ liệu fallback
